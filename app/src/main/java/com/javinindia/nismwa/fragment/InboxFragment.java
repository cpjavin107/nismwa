...
/**
 * Created by ashis on 11/17/2017.
 */

public class InboxFragment extends BaseFragment implements NotificationAdopter.MyClickListener {
    ...
    private void initialize(View view) {
        ...
        imgAdds = (ImageView) view.findViewById(R.id.imgAdds);
        ...
        adapter.setMyClickListener(InboxFragment.this);
