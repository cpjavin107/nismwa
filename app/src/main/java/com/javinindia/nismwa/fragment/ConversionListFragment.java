...
import com.javinindia.nismwa.modelClasses.convrsionparsing.ConversionResponse;
...
import com.javinindia.nismwa.recyclerView.ConevrsionAdopter;
...
public class ConversionListFragment extends BaseFragment implements ConevrsionAdopter.MyClickListener {
    AppCompatTextView txtTitle, txtLoading;
    ImageView imgBack, imgAdds;
    ProgressBar progressBar;
    private RecyclerView recyclerview;
    private ConevrsionAdopter adapter;
    ...
    private void sendDataOnApi(final int page) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.CONVERSION_LIST_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        int status = 0;
                        String msg;
                        final ConversionResponse candidateQuickJobsResponse = new ConversionResponse();
                        ...
                        try {
                            ...
                            if (status == 1) {
                                if (candidateQuickJobsResponse.getConversionDetailArrayList().size() > 0) {
                                    arrayList = candidateQuickJobsResponse.getConversionDetailArrayList();
                                    if (arrayList.size() > 0) {
                                        txtLoading.setText(" ");
    ...
    private void initialize(View view) {
        ...
        txtTitle.setText("Conversion List");
        ...
        adapter = new ConevrsionAdopter(activity);
        recyclerview.setAdapter(adapter);
        adapter.setMyClickListener(ConversionListFragment.this);
    ...
    @Override
    public void onItemUseClick(int position, ConversionDetail model) {
