...
import com.javinindia.nismwa.modelClasses.suggestionparsing.SuggestionResponse;
import com.javinindia.nismwa.preference.SharedPreferencesManager;
import com.javinindia.nismwa.recyclerView.EventAdapter;
import com.javinindia.nismwa.recyclerView.SuggestionAdopter;
...
/**
 * Created by ashish on 11/21/2017.
 */

public class MySuggestionFragment extends BaseFragment implements SuggestionAdopter.MyClickListener {
    AppCompatTextView txtTitle, txtLoading;
    ImageView imgBack, imgAdds;
    ProgressBar progressBar;
    private RecyclerView recyclerview;
    private SuggestionAdopter adapter;
    ...
    private void sendDataOnApi(final int page) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.SUGGESTION_LIST_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        int status = 0;
                        String msg;
                        final SuggestionResponse candidateQuickJobsResponse = new SuggestionResponse();
                        ...
                        try {
                            ...
                            if (status == 1) {
                                if (candidateQuickJobsResponse.getSuggestionDetailArrayList().size() > 0) {
                                    arrayList = candidateQuickJobsResponse.getSuggestionDetailArrayList();
                                    if (arrayList.size() > 0) {
                                        txtLoading.setText(" ");
    ...
    private void initialize(View view) {
        ...
        adapter = new SuggestionAdopter(activity);
        recyclerview.setAdapter(adapter);
        adapter.setMyClickListener(MySuggestionFragment.this);
    ...
    @Override
    public void onEventClick(int position, SuggestionDetail detailEventItem) {
