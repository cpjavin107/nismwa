...
public class NewsFragment extends BaseFragment implements EventAdapter.MyClickListener {
    ...
    private void sendDataOnApi(final int page) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.NEWS_LIST_URL,
    ...
    private void initialize(View view) {
        ...
        adapter = new EventAdapter(activity, 2);
        recyclerview.setAdapter(adapter);
        adapter.setMyClickListener(NewsFragment.this);
