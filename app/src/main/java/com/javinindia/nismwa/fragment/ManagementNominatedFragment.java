...
public class ManagementNominatedFragment extends BaseFragment implements View.OnClickListener {
    private RequestQueue requestQueue;
    private int page = 5;
    private String ownerId;
    ImageView imgBack, imgOne, imgTwo, imgThree, imgFour;
    AppCompatTextView txtOne, txtTwo, txtThree, txtFour, txtNext, txtTitle, txtPrevious, txtNext1;
    RelativeLayout rlFour, rlOne, rlTwo, rlThree;
    LinearLayout llNext;
    int fram;
    ...
    private void clickMethod(View view) {
        ...
        txtNext1.setOnClickListener(this);
    ...
    private void initialize(View view) {
        ...
        txtTitle.setText("Nominated Member");
        ...
        txtNext1 = view.findViewById(R.id.txtNext1);
        txtNext1.setTypeface(FontRobotoCondensedRegularSingleTonClass.getInstance(activity).getTypeFace());
    ...
    protected int getFragmentLayout() {
        return R.layout.management_one_layout;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.imgBack:
                ...
                break;
            case R.id.txtNext1:
                MemberArbitrationFragment memberArbitrationFragment = new MemberArbitrationFragment();
                callFragmentMethod(memberArbitrationFragment, Constants.FRG_MANAGEMENT_ARBITRATION_LIST, fram);
                break;
