...
public class ManagementXblockFragment extends BaseFragment implements View.OnClickListener {
    ...
    private void initialize(View view) {
        ...
        txtTitle.setText("Executive Committee(X-Block)");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.imgBack:
                ...
                break;
            case R.id.txtNext:
                ManagementYblockFragment managementYblockFragment = new ManagementYblockFragment();
                callFragmentMethod(managementYblockFragment, Constants.FRG_MANAGEMENT_YBLOCK_LIST, fram);
                break;
