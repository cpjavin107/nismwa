...
public class ManagementYblockFragment extends BaseFragment implements View.OnClickListener {
    ...
    private void initialize(View view) {
        ...
        txtTitle.setText("Executive Committee(Y-Block)");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.imgBack:
                ...
                break;
            case R.id.txtNext:
                ManagementZblockFragment managementZblockFragment = new ManagementZblockFragment();
                callFragmentMethod(managementZblockFragment, Constants.FRG_MANAGEMENT_ZBLOCK_LIST, fram);
                break;
