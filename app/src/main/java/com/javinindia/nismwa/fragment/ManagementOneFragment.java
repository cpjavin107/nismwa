...
public class ManagementOneFragment extends BaseFragment implements View.OnClickListener {
    private RequestQueue requestQueue;
    private int page = 1;
    private String ownerId;
    ImageView imgBack, imgOne, imgTwo, imgThree, imgFour;
    AppCompatTextView txtOne, txtTwo, txtThree, txtFour, txtNext, txtTitle;
    ...
    private void initialize(View view) {
        ...
        txtTitle.setText("Executive Committee");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.imgBack:
                ...
                break;
            case R.id.txtNext:
                ManagementXblockFragment managementXblockFragment = new ManagementXblockFragment();
                callFragmentMethod(managementXblockFragment, Constants.FRG_MANAGEMENT_XBLOCK_LIST, fram);
                break;
        }
    }
}
